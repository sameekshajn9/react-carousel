...
const CarouselComponent = (props) => {
  ...
  const prevIndex =
    activeIndex - 1 >= 0 ? activeIndex - 1 : products.length - 1;
  ...
  return (
    <div className="image-slider">
      ...
      {products[prevIndex] && (
        <div
          className={`left ${
            direction === Directions.showNext ? "left-next" : ""
          }`}
          key={prevIndex}
        >
          <CardComponent
            className={`left-image ${
              direction === Directions.showNext ? "" : "left-image-prev"
            }`}
      ...
      {products[activeIndex] && (
        <div
          className={`center ${
            direction === Directions.showNext ? "" : "center-prev"
          }`}
          key={activeIndex}
        >
          <CardComponent
      ...
      {products[nextIndex] && (
        <div
          className={`right ${
            direction === Directions.showNext ? "" : "right-prev"
          }`}
          key={nextIndex}
        >
          <CardComponent
            ...
            className={`right-image ${
              direction === Directions.showNext ? "" : "right-image-prev"
            }`}
          />
        </div>
      )}
